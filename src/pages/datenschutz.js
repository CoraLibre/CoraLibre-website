...
const PrivacyPolicyPage = () => {
    return (
        <Layout>
            ...
            <p>Für die Datenverarbeitung bei der Nutzung der Internetseite von www.coralibre.de und ihrer Unterseiten
                ist die cosee
                GmbH, vertr.d.d. GF Herrn Patrick Wolf, Mina-Rees-Straße 8, 64295 Darmstadt, E-Mail: info@cosee.biz,
                Tel.: +49 6151 95744-0, Fax: +49 6151 95744-29 (nachfolgend: cosee) verantwortlich.</p>
            <h3>Datenschutzbeauftragter</h3>
            <p>Datenschutzbeauftragte der cosee GmbH ist:<br/>
                Jens van Radecke<br/>
                Vancom IT GmbH<br/>
                Am Wingert 5<br/>
                63856 Bessenbach<br/>
            ...
            <p>
                Der Zweck der Datenschutzbestimmungen besteht darin, Sie darüber zu informieren, welche Daten die cosee
                GmbH
                ...
                diesem
                Zusammenhang gespeicherten Informationen ändern oder ihre Löschung oder Sperrung veranlassen können.</p>
            <p>
                1. Gegenstand des Datenschutzes<br/>
                Gegenstand des Datenschutzes sind personenbezogene Daten. Diese sind nach § 3 Abs. 1 BDSG Einzelangaben
                über
                ...
                keine
                Einholung einer Einwilligung</p>
            <p>
                2. Rechtsgrundlage der Datenverarbeitung<br/>
                Die Verarbeitung der personenbezogenen Daten der Besucher unserer Internetseite ist zur Wahrung eines
            ...
            <p>
                3. Löschung der Daten und Dauer der Speicherung<br/>
                Die Daten mit Personenbezug zum Betroffenen werden gelöscht oder gesperrt, sobald der Zweck der
                Speicherung
            ...
            <p>
                Im Folgenden klären wir Sie über den Umfang der Datenerhebung und -speicherung sowie deren Nutzung und
                über
                den Zweck der jeweiligen Datenerhebung auf.</p>
            <p>
                <strong>1. Logfiles</strong><br/>
                Wir nutzen Netlify, 2325 3rd St #215, San Francisco, CA 94107, USA, als Hosting-Lösung für unsere
                Webseiten. Die
                Datenschutzbestimmungen von Netlify können Sie unter dieser Internetadresse einsehen:
            ...
            <p>
                Bei der Nutzung der Webseite www.coralibre.de und Unterseiten werden die folgenden Daten automatisiert von
                unserem Dienstleister, der Firma Netlify, 2325 3rd St #215, San Francisco, CA 94107, USA, erfasst und in
                einem
                Logfile auf deren Server in den USA gespeichert:
                <ul>
                    <li>IP-Adresse</li>
                ...
                Die Logfiles dieses Servers enthalten IP-Adressen oder sonstige Daten, die eine Zuordnung zu einem
                Nutzer
            ...
            <p>
                ...
                vereinbart
                haben („Privacy Shield“).
            </p>
            <p>
                <strong>3. Zweck der Datenverarbeitung</strong><br/>
                Die vorübergehende Speicherung der IP-Adresse durch Netlify ist notwendig, um eine Auslieferung der
                Website an
            ...
            <p>
                ...
                Eine Kontaktaufnahme ist über die bereitgestellten E-Mail-Adressen möglich. In diesem Fall werden die mit der EMail übermittelten personenbezogenen Daten des Nutzers gespeichert. Wir nutzen Dogado
                (<a target="_blank" href="https://www.dogado.de/" rel="noopener noreferrer" className="link">www.dogado.de</a>) als Dienstleister für den E-Mail-Dienst. Die Daten werden ausschließlich für die Bearbeitung
            ...
            <p>
                <strong>3. Zweck der Datenverarbeitung</strong><br/>
                Bei der Verarbeitung der personenbezogenen Daten bei einer Kontaktaufnahme per E-Mail erfolgt die
            ...
            <p>
                <strong>4. Dauer der Speicherung</strong><br/>
                Die Daten bleiben bis zum Ablauf der handelsrechtlichen Speicherfristen (10 Jahre) gespeichert. Sind die Daten zum
                Zweck der Konversation nicht mehr erforderlich, werden die Daten auf lokalen Geräten gelöscht und auf dem Server
                von Webcontrol bis zum Ablauf der Speicherfrist aufbewahrt.
            </p>
            <p>
